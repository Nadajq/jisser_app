  ...
  Centers({
    ...
    final List<Centers> centerslist = [
      Centers(
        name: 'جمعية إرادة',
        location: 'نجران',
        description: 'جمعية إرادة التوحد جمعية تُعنى بخدمة ذوي اضطراب التوحد بمنطقة نجران وتسعى لمساعدة ذوي اضطراب التوحد وأُسرهم ودعمهم تدريباً وتأهيلاً وتعليماً ليكونوا أعضاء فاعلين في المجتمع لتحقيق ذواتهم.',
      ...
      Centers(
          name: 'مركز التميمي',
          location: 'عنيزة',
          description: 'مركز الشيخ علي بن عبد الله التميمي للتوحد مركز خيري يسعى لتلبية احتياجات الأشخاص ذوي التوحد وأسرهم من خلال تبني أفضل المنهجيات والنظم لجودة وشمولية الخدمات في إطار رؤية مستقبلية شاملة لإحداث تغيير إيجابي في حياتهم تمكنهم من الاندماج في المجتمع والمشاركة فيه بفاعلية.',
